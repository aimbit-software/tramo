...
export const BUTTON_PRIMARY =
  "inline-flex items-center gap-2 rounded-tile bg-accent pressable px-3 py-1.5 font-display text-sm font-medium text-on-accent duration-150 ease-signature hover:opacity-90 aria-disabled:cursor-wait aria-disabled:opacity-60 motion-reduce:transition-none";
...
export const SEGMENT = (checked: boolean) =>
  `px-2 py-0.5 text-xs transition-colors duration-150 ease-signature motion-reduce:transition-none ${
