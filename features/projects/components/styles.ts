...
export const BUTTON_GHOST =
  "inline-flex items-center gap-2 rounded-tile px-3 py-1.5 font-display text-sm text-ink-muted transition-colors duration-150 ease-signature hover:bg-raised hover:text-ink motion-reduce:transition-none";
